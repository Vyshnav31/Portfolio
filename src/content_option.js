const logotext = "A.Vyshnav Kumar";
const meta = {
    title: "A.Vyshnav Kumar",
    description: "I’m A.Vyshnav Kumar Full stack devloper",
};

const introdata = {
    title: "I’m A.Vyshnav Kumar",
    animated: {
        first: "I love coding",
...
const dataportfolio = [{
        img: "https://cdn-icons-png.flaticon.com/512/7477/7477790.png",
        description: "Weather application which show real time information",
        link: "https://weather-application-sage-nu.vercel.app/",
    },
    {
    ...
    },
    {
        ...
        description: "Predict Taxi Trip",
        link: "https://github.com/Vyshnav31/Predict_Taxi_Trip",
    },
    
];

const contactConfig = {
    YOUR_EMAIL: "vyshnavkumar.a2021@vitstudent.ac.in",
    YOUR_FONE: "6302577402",
